...
<body>
    ...
    <div class="d-flex justify-content-center my-4">
        <div class="card mb-3 my-4 border-0" style="width: 1600px; height: 700px;">
            <div class="row g-0">
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title mb-4 fs-2">{{ $Movie->title }}</h5>
                        <p class="card-text mb-4">Description : {{ $Movie->description }}</p>
                        <p class="card-text mb-4">Genre : <a
                                href="/genre/{{ $Movie->genre_id }}">{{ $Movie->genre->name }}</a>
                        </p>
                        <p class="card-text mb-4">Rating : {{ $Movie->rating }} <svg
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
